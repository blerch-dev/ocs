...
export const chatComponent = (url: string, title?: string) => {
    return `<iframe src="${url}" title="${title ?? "Chat Window"}"></iframe>`;
}

// export const _chatComponent = (title: string, options?: chatOptions) => {
//     let cv = 0;
